      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
        <AnimatedSection>
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6 leading-[1.1]">
            The Origin of <span className="font-bold" style={{ color: '#f97415' }}>APEXIS</span>
          </h2>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.1}>
          <div className="space-y-4 text-muted-foreground leading-relaxed text-base font-light">
            ...
            <p>
              <span className="font-bold" style={{ color: '#f97415' }}>APEXIS</span> aims to bring technology-driven clarity, accountability, and organized communication into construction projects.
            </p>
            <p>
              By creating a centralized platform for updates and progress tracking, <span className="font-bold" style={{ color: '#f97415' }}>APEXIS</span> helps ensure that everyone involved in a project — from clients to professionals — stays aligned and informed.
            </p>
          </div>
        </AnimatedSection>
